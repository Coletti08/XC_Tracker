...
export function SpeedPlot({ points, selected, cursorTime }) {
    ...
    if (!graph.hasSpeed)
        return <p className="text-secondary p-4 mb-0">Speed unavailable</p>;
    return (<svg className="speed-plot" viewBox="0 0 800 150" role="img" aria-label="Speed in miles per hour over elapsed time">
